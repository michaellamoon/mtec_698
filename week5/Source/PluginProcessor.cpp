...
//==============================================================================
Week5AudioProcessor::Week5AudioProcessor()
...
//==============================================================================
const juce::String Week5AudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool Week5AudioProcessor::acceptsMidi() const
{
...
bool Week5AudioProcessor::producesMidi() const
{
...
bool Week5AudioProcessor::isMidiEffect() const
{
...
double Week5AudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int Week5AudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int Week5AudioProcessor::getCurrentProgram()
{
    return 0;
}

void Week5AudioProcessor::setCurrentProgram (int index)
{
}

const juce::String Week5AudioProcessor::getProgramName (int index)
{
    return {};
}

void Week5AudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}

//==============================================================================
void Week5AudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
void Week5AudioProcessor::releaseResources()
{
...
bool Week5AudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void Week5AudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
ParameterManager* Week5AudioProcessor::getParameterManager()
{
    return mParameterManager.get();
}

//==============================================================================
bool Week5AudioProcessor::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

juce::AudioProcessorEditor* Week5AudioProcessor::createEditor()
{
    return new Week5AudioProcessorEditor (*this);
}

//==============================================================================
void Week5AudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
void Week5AudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
...
{
    return new Week5AudioProcessor();
}
